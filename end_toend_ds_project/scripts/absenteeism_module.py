...
class absenteeism_model():
        ...
        def __init__(self, model_file, scaler_file):
            ...
            with open('../scripts/model','rb') as model_file, open('../scripts/scaler', 'rb') as scaler_file:
        ...
        def load_and_clean_data(self, data_file):
            ...
            # to preserve the code we've created in the previous section,
            #  we will add a column with 'NaN' strings
